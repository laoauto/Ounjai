    ...
    <div class="login-screen">
      <div class="login-card">
        <div class="login-logo">
          <img src="icons/icon-512.png" alt="ນ້ຳດື່ມ ອຸ່ນໃຈ" />
        </div>
        <h1 class="login-title">ນ້ຳດື່ມ ອຸ່ນໃຈ</h1>
        <p class="login-subtitle">ສະອາດ ປອດໄພ ໃສ່ໃຈສຸຂະພາບ</p>
...
const ADMIN_NAV = [
  ...
  { key: 'sell_agent', label: 'ຂາຍໃຫ້ຕົວແທນ', icon: '🚚' },
  { key: 'sell_retail', label: 'ຂາຍປີກທົ່ວໄປ', icon: '🏬' },
...
function navigateAdmin(view) {
  ...
  const renderers = {
    ...
    sell_agent: renderAdminSellAgent,
    sell_retail: renderAdminSellRetail,
...
async function renderAdminSellAgent(main) {
  main.innerHTML = `
    <div class="page-header">
      <div>
        <h1 class="page-title">ຂາຍໃຫ້ຕົວແທນ</h1>
        <div class="page-subtitle">ຕັດສະຕັອກໂຮງງານ ແລະ ບວກເຂົ້າສະຕັອກຕົວແທນອັດຕະໂນມັດ</div>
      </div>
    </div>
    <div id="sell-agent-content"><div class="spinner"></div></div>
  `;
  await drawSellToAgentForm(main.querySelector('#sell-agent-content'), main);
}

async function renderAdminSellRetail(main) {
  main.innerHTML = `
    <div class="page-header">
      <div>
        <h1 class="page-title">ຂາຍປີກທົ່ວໄປ</h1>
        <div class="page-subtitle">ຂາຍໃຫ້ລູກຄ້າທົ່ວໄປໜ້າໂຮງງານໂດຍກົງ, ຕັດສະຕັອກໂຮງງານທັນທີ</div>
      </div>
    </div>
    <div id="sell-retail-content"><div class="spinner"></div></div>
  `;
